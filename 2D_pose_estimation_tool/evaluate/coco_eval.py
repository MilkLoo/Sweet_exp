...
from libary.datasets.preprocessing import (inception_preprocess,
                                        rtpose_preprocess,
...
parser.add_argument('--cfg', help='experiment configure file name',
                    default='/home/ly/yxc_exp_smpl/2D_pose_estimation_tool/experiments/vgg19_368x368_sgd.yaml', type=str)
...
def append_result(image_id, humans, upsample_keypoints, outputs):
    ...
    """
    for human in humans:
        one_result = {"image_id": image_id, "category_id": 1, "keypoints": [], "score": 0}
