...
class SMPL_Layer(Module):
    ...
    def __init__(self,
                 center_idx=None,
                 gender='neutral',
                 model_root='/home/ly/yxc_exp_smpl/common/utils/smplpytorch/smplpytorch/native/models'):
        """
        Args:
    ...
    # common/utils/smplpytorch/smplpytorch/native/models/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl
