...
from common.utils.manopth import manopth
...
class MANO(object):
    ...
    def get_layer(self):
        return ManoLayer(mano_root=osp.join(cfg.mano_path, 'mano', 'models'), flat_hand_mean=False,
                         use_pca=False)  # load right hand MANO model
