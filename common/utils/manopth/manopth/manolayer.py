...
from common.utils.manopth.mano.webuser.smpl_handpca_wrapper_HAND_only import ready_arguments
from common.utils.manopth.manopth import rodrigues_layer, rotproj, rot6d
from common.utils.manopth.manopth.tensutils import (th_posemap_axisang, th_with_zeros, th_pack,
...
class ManoLayer(Module):
    ...
    def __init__(self,
                 ...
                 ncomps=6,
                 side='right',
                 mano_root='/home/ly/yxc_exp_smpl/common/utils/manopth/mano/models',
                 use_pca=True,
