...
class HMR2DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if self.train_dataset == None:
            self.train_dataset = MixedWebDataset(self.cfg, self.dataset_cfg, train=True).with_epoch(100_000).shuffle(
                4000)
    ...
    def train_dataloader(self) -> Dict:
        ...
        mocap_dataloader = torch.utils.data.DataLoader(self.mocap_dataset,
